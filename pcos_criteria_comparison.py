...
Compares the three main PCOS diagnostic criteria sets:
  ...
  - AES/AE-PCOS 2006 (Androgen Excess Society)
...
Data sourced from:
  ...
  - GitHub context: zhub9006/pcos-criteria-comparison & endocrinologyindia/nie2
"""
...
fig.text(0.5, 0.01,
         ...
         "Context: github.com/zhub9006/pcos-criteria-comparison · github.com/endocrinologyindia/nie2",
